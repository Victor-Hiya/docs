...
the Loccus AI voice identity service, in order to securely authenticate users with their voice.
...
sequenceDiagram
    ...
    Your System->>+Loccus AI: Audio(s)
    rect rgba(255, 0, 0, .1)
    note over Customer, Loccus AI: Verify the audios
    Your System->>Loccus AI: Perform Message Verification
    Your System->>Loccus AI: Perform Authenticity Verification
    Loccus AI-->>-Your System: Verification Results
    ...
    rect rgba(0, 255, 0, .1)
    note over Customer, Loccus AI: Compute the voiceprint
    Your System->>+Loccus AI: Compute Voiceprint
    Loccus AI-->>-Your System: Voiceprint OK
...
sequenceDiagram
    ...
    note over Customer, Loccus AI: Verify the audio
    Your System->>Loccus AI: Audio
    Your System->>Loccus AI: Perform Message Verification
    Your System->>Loccus AI: Perform Identity Verification
    destroy Loccus AI
    Loccus AI-->>Your System: Verification Results
