...
Testing the Loccus AI Platform for accuracy and reliability, in your 
...
<Tip>You can check the [batch testing script in the Loccus AI Github Examples][4] repository for quickly running authenticity verifications.</Tip>
