...
the Loccus AI voice verification service, in order to detect fraud, protect your client's data
and improve operational efficiency.

<Note>This is just a sample, meant to cover the general call center use case. 
...
critical Call Establishment
    ...
    IVR ->> Loccus AI: Audio
    destroy Loccus AI
    Loccus AI -->> IVR: Verification Result
...
<Steps>
  <Step title="Record the voice">
    You need to have a record of the client call. This is usually accomplished via some voice protocol 
    like SIPRec, and is also often required for legal compliance. 
  ...
  <Step title="Send the voice for verification">
    ...
    <Tip>Since [only few voice seconds are needed][6] for accurate results, you can reuse the
    existing IVR input you use for routing as verification.</Tip>
  </Step>
