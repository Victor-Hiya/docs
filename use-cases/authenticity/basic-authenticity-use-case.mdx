...
the Loccus AI voice verification service, in order to detect synthetic voices or replays.
...
# Architecture
You can use Loccus API to verify voice as soon as is processed by your system. 
...
sequenceDiagram
    ...
    Your System->>+Loccus AI: Voice Snippet
    Loccus AI-->>-Your System: Verification Result
